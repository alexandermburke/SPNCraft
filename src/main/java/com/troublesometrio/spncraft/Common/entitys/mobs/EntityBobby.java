...
public class EntityBobby extends EntityGolem
{
    ...
    public EntityBobby(World par1World)
    {
        super(par1World);
    ...
    {
    	this.dropItem(SupernaturalCraft.Bible, 1);
    	this.dropItem(SupernaturalCraft.RabbitsFoot, 1);
    }
