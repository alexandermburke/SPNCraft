...
public class EntityCastiel extends EntityGolem
{
    ...
    public EntityCastiel(World par1World)
    {
        super(par1World);
    ...
    {
    	this.dropItem(SupernaturalCraft.AngelBlade, 1);
    	this.dropItem(SupernaturalCraft.AngelBlood, 1);
    }
