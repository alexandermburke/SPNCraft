...
public class EntityDeanDemon extends EntityGolem
{
    ...
    public EntityDeanDemon(World par1World)
    {
        super(par1World);
        ...
        this.tasks.addTask(2, new EntityAIHurtByTarget(this, false));
        this.tasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityLiving.class, 0, false, true, IMob.mobSelector));
    }
    ...
    {
    	this.dropItem(SupernaturalCraft.DemonBlood, 1);
    	this.dropItem(SupernaturalCraft.DemonKnife, 1);
