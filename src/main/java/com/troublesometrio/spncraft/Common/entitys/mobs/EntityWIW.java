...
public class EntityWIW extends EntityMob
{
    ...
    /** Counter to delay the teleportation of an WIW towards the currently attacked target */
    private int teleportDelay;
    /** A player must stare at an WIW for 5 ticks before it becomes aggressive. This field counts those ticks. */
    private int stareTimer;
    private Entity lastEntityToAttack;
    private boolean isAggressive;
    private static final String __OBFID = "CL_00001685";

    public EntityWIW(World p_i1734_1_)
    {
        super(p_i1734_1_);
    ...
    /**
     * Checks to see if this WIW should be attacking this player
     */
        ...
        if (!this.worldObj.isRemote && this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"))
        {
            ...
            if (this.func_146080_bZ().getMaterial() == Material.air)
            {
                if (this.rand.nextInt(20) == 0)
                {
                    ...
                    if (EntityWIW.getCarriable(block))
                    {
    ...
    /**
     * Teleport the WIW to a random nearby position
     */
    ...
    /**
     * Teleport the WIW to another entity
     */
    ...
    {
    	this.dropItem(SupernaturalCraft.Ectoplasm, 1);
    ...
    /**
     * Set the metadata of the block an WIW carries
     */
    ...
    /**
     * Get the metadata of the block an WIW carries
     */
